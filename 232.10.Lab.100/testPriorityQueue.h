...
public:
   ...
   {  // setup
      //   v = [10,9,8]
      custom::vector <int> v{int(10), int(9), int(8)};
      // exercise
      custom::priority_queue <int> pq(v);
      // verify
      //  +---+---+---+
      ...
      if (v.size() == 3)
      {
         assertUnit(v[0] == int(10));
         assertUnit(v[1] == int(9));
   ...
   {  // setup
      ...
      {
         assertUnit(std::string(s) == std::string("std:out_of_range"));
      }
